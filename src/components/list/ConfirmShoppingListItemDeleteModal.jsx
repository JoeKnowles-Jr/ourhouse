...
const ConfirmShoppingListItemDeleteModal = ({ show, handleClose, id }) => {
  const [loading, setLoading] = useState(false);
  const { setErrorMsg, deleteShoppingListItem } = useShoppingListItems();
...
export default ConfirmShoppingListItemDeleteModal;
